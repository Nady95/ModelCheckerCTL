...
/**
 * Classe permettant de représenter une formule CTL de la forme A(phi1 Until phi2).
 *
 * @author Nady Saddik
...
public class AU implements CTLFormula {
    ...
    /**
     * Constructeur permettant d'instancier une formule CTL de type A(phi1 Until phi2).
     *
     * @param operand1 phi1
     * @param operand2 phi2
     */
